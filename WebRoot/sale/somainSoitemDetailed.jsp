...
<body>
	...
	<table width="100%" border="0" align="center" cellspacing="1"
		...
		<c:forEach items="${cll }" var="soitem" varStatus="i">
			<tr align="center">
				<td>${i.index+1 }</td>
				<td><input type="text" name="spbm" size="10"
					readonly="readonly" value="${soitem.productCode }"></td>
				<td><input type="text" name="spmc" size="15"
					readonly="readonly" value="${soitem.productName }"></td>
				<td><input type="text" name="ytsl" size="10"
					readonly="readonly" value="${soitem.num }"></td>
				<td><input type="text" name="sptj" size="10"
					readonly="readonly" value="${soitem.unitName }"></td>
				<td><input type="text" name="spzl" size="10"
					readonly="readonly" value="${soitem.unitPrice }"></td>
				<td><input type="text" name="stsl" size="10"
					readonly="readonly" value="${soitem.itemPrice }"></td>
